...
func (_m *mockStrategyTarget) Ports(ctx context.Context) (network.PortMap, error) {
	ret := _m.Called(ctx)
	...
	var r0 network.PortMap
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (network.PortMap, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) network.PortMap); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(network.PortMap)
		}
	}
...
func (_c *mockStrategyTarget_Ports_Call) Return(_a0 network.PortMap, _a1 error) *mockStrategyTarget_Ports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockStrategyTarget_Ports_Call) RunAndReturn(run func(context.Context) (network.PortMap, error)) *mockStrategyTarget_Ports_Call {
	_c.Call.Return(run)
	return _c
}
