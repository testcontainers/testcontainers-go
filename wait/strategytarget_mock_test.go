...
func (_m *mockStrategyTarget) MappedPort(_a0 context.Context, _a1 string) (network.Port, error) {
	...
	var r0 network.Port
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, string) (network.Port, error)); ok {
		return rf(_a0, _a1)
	}
	if rf, ok := ret.Get(0).(func(context.Context, string) network.Port); ok {
		r0 = rf(_a0, _a1)
	} else {
...
func (_c *mockStrategyTarget_MappedPort_Call) Run(run func(_a0 context.Context, _a1 string)) *mockStrategyTarget_MappedPort_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *mockStrategyTarget_MappedPort_Call) RunAndReturn(run func(context.Context, string) (network.Port, error)) *mockStrategyTarget_MappedPort_Call {
	_c.Call.Return(run)
	return _c
}

// Ports provides a mock function with given fields: ctx
func (_m *mockStrategyTarget) Ports(ctx context.Context) (map[network.Port][]network.PortBinding, error) {
	ret := _m.Called(ctx)
	...
	var r0 map[network.Port][]network.PortBinding
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context) (map[network.Port][]network.PortBinding, error)); ok {
		return rf(ctx)
	}
	if rf, ok := ret.Get(0).(func(context.Context) map[network.Port][]network.PortBinding); ok {
		r0 = rf(ctx)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(map[network.Port][]network.PortBinding)
		}
	}
...
func (_c *mockStrategyTarget_Ports_Call) Return(_a0 map[network.Port][]network.PortBinding, _a1 error) *mockStrategyTarget_Ports_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *mockStrategyTarget_Ports_Call) RunAndReturn(run func(context.Context) (map[network.Port][]network.PortBinding, error)) *mockStrategyTarget_Ports_Call {
	_c.Call.Return(run)
	return _c
}
