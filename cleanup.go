...
func (o *TerminateOptions) Cleanup() error {
	...
	dockerClient, err := NewDockerClientWithOpts(o.ctx)
	if err != nil {
	...
	for _, volume := range o.volumes {
		if _, errRemove := dockerClient.VolumeRemove(o.ctx, volume, client.VolumeRemoveOptions{Force: true}); errRemove != nil {
