...
// Finally, if the network is not "bridge", it sets the network alias on that network to the given alias.
// This is because network-scoped alias is supported only for containers in user defined networks.
