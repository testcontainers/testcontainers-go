...
// Deprecated: use testcontainers-go [image.Substitutor] instead
// ImageSubstitutor represents a way to substitute container image names
type ImageSubstitutor = image.Substitutor

// Deprecated: use testcontainers-go [image.CustomHubSubstitutor] instead
...
type CustomHubSubstitutor = image.CustomHubSubstitutor

// Deprecated: use testcontainers-go [image.NewCustomHubSubstitutor] instead
// NewCustomHubSubstitutor creates a new CustomHubSubstitutor
func NewCustomHubSubstitutor(hub string) CustomHubSubstitutor {
	return image.NewCustomHubSubstitutor(hub)
}
