...
func TestRegistry_unauthenticated(t *testing.T) {
	...
	terminateContainerOnEnd(t, ctx, ctr.DockerContainer)
...
func TestRunContainer_authenticated(t *testing.T) {
	...
	terminateContainerOnEnd(t, ctx, registryContainer.DockerContainer)
	require.NoError(t, err)
...
func terminateContainerOnEnd(tb testing.TB, ctx context.Context, ctr *testcontainers.DockerContainer) {
	tb.Helper()
