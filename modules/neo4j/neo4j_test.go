...
func TestNeo4j(outer *testing.T) {
	...
	container, err := setupNeo4j(ctx, outer)
	testcontainers.CleanupContainer(outer, container)
...
func setupNeo4j(ctx context.Context, t *testing.T) (*neo4j.Neo4jContainer, error) {
